...
<div class="contain-fluid">
    <div class="col-lg-12 "id="cat-cont">
        <div class="row">
            <div class="col-md-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        <ul class='list-group' id='cat-list'>
                            <li class='list-group-item' data-id='all' data-href="index.php?page=category">All</li>
                            <?php
                                $cat = $conn->query("SELECT * FROM categories order by name asc");
                                while($row=$cat->fetch_assoc()):
                                    $cat_arr[$row['id']] = $row['name'];
                             ?>
                            <li class='list-group-item' data-id='<?php echo $row['id'] ?>' data-href="index.php?page=category&category_id=<?php echo $row['id'] ?>"><?php echo ucwords($row['name']) ?></li>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <?php
                                ...
                                if($cat->num_rows <= 0){
                                    echo "<center><h4>No Available Product.</h4></center>";
                                } 
                                while($row=$cat->fetch_assoc()):
                             ?>
                             <div class="col-sm-4">
